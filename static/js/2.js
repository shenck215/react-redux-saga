...
var _paymentManagementListAction = __webpack_require__(59);

var _paymentManagementList = __webpack_require__(431);

var _paymentManagementList2 = _interopRequireDefault(_paymentManagementList);
...
var PaymentManagementListApp = function (_Component) {
    _inherits(PaymentManagementListApp, _Component);

    function PaymentManagementListApp(props) {
        _classCallCheck(this, PaymentManagementListApp);

        /**
         * 初始状态
         */
        var _this = _possibleConstructorReturn(this, (PaymentManagementListApp.__proto__ || Object.getPrototypeOf(PaymentManagementListApp)).call(this, props));
        ...
        _this.getcolumns = function () {
            return [{
                ...
                render: function render(text, record) {
                    if (record.paymentStatus == 1) {
                        return _react2.default.createElement(
                            'span',
                            { className: _paymentManagementList2.default.cancelBtn, onClick: function onClick() {
                                    _this.cancelButton(text);
                                } },
                            '\u53D6\u6D88'
                        );
                    } else {
                ...
                title: _react2.default.createElement(
                    ...
                    { title: '\u8BF7\u6B3E\u5355\u53F7', type: 'filter', ok: function ok(e) {
                            return _this.searchBtn('paymentCode');
                        } },
                    _react2.default.createElement(_antd.Input, {
                        defaultValue: _this.props.paymentCode,
                        value: _this.state.paymentCode,
                        onChange: function onChange(e) {
                            return _this.handleSearchChangeCache(e.target['value'], 'paymentCode');
                        }
                    })
                ),
                ...
                render: function render(text, _render) {
                    return _react2.default.createElement(
                        _reactRouter.Link,
                        { to: '/jsp/react/request/requestdetail', onClick: function onClick() {
                                _this.goToDetail(_render.id);
                            } },
                        text
                    );
                }
                ...
                title: _react2.default.createElement(
                    _filterTable2.default,
                    { title: '\u8BF7\u6B3E\u4EBA', type: 'filter', ok: function ok(e) {
                            return _this.searchBtn('paymentName');
                        } },
                    _react2.default.createElement(_antd.Input, {
                        defaultValue: _this.props.paymentName,
                        value: _this.state.paymentName,
                        onChange: function onChange(e) {
                            return _this.handleSearchChangeCache(e.target['value'], 'paymentName');
                        }
                    })
                ),
                ...
                title: _react2.default.createElement(
                    _filterTable2.default,
                    { title: '\u8BF7\u6B3E\u91D1\u989D(\u5143)', type: 'filter', ok: function ok(e) {
                            return _this.searchBtn('amt');
                        } },
                    _react2.default.createElement(
                        _antd.Select,
                        {
                            allowClear: true,
                            defaultValue: _this.props.amt ? _this.props.amt : '请选择',
                            style: { width: 150 },
                            value: _this.state.amt,
                            onChange: function onChange(value) {
                                return _this.handleSearchChangeCache(value, 'amt');
                            }
                        },
                        _react2.default.createElement(
                            Option,
                        ...
                        _react2.default.createElement(
                            Option,
                            { value: '1000.01~2000.00' },
                            '1000.00~2000.00'
                        ),
                        _react2.default.createElement(
                            Option,
                            { value: '2000.01~3000.00' },
                            '2000.00~3000.00'
                        ),
                        _react2.default.createElement(
                            Option,
                            { value: '3000.01~5000.00' },
                            '3000.00~5000.00'
                        ),
                        _react2.default.createElement(
                            Option,
                ...
                title: _react2.default.createElement(
                    _filterTable2.default,
                    { title: '\u8BF7\u6B3E\u65F6\u95F4', type: 'filter', ok: function ok(e) {
                            return _this.searchBtn('createTime');
                        } },
                    _react2.default.createElement(RangePicker, {
                        defaultValue: _this.props.createTime ? _this.props.createTime : '',
                        value: _this.state.createTime,
                        onChange: function onChange(data, dataString) {
                            return _this.handleSearchChangeCache(data, 'createTime');
                        }
                    })
                ),
                ...
                key: 'createTime',
                render: function render(text) {
                    return (0, _moment2.default)(text * 1000).format('YYYY-MM-DD HH:mm:ss');
                }
            }, {
                title: _react2.default.createElement(
                    _filterTable2.default,
                    { title: '\u76F8\u5173\u53C2\u4FDD\u4EBA', type: 'filter', ok: function ok(e) {
                            return _this.searchBtn('paymentInsurerNames');
                        } },
                    _react2.default.createElement(_antd.Input, {
                        defaultValue: _this.props.paymentInsurerNames,
                        value: _this.state.paymentInsurerNames,
                        onChange: function onChange(e) {
                            return _this.handleSearchChangeCache(e.target['value'], 'paymentInsurerNames');
                        }
                    })
                ),
                ...
                title: _react2.default.createElement(
                    _filterTable2.default,
                    { title: '\u72B6\u6001', type: 'filter', ok: function ok(e) {
                            return _this.searchBtn('paymentStatus');
                        } },
                    _react2.default.createElement(
                        _antd.Select,
                        {
                            allowClear: true,
                            defaultValue: _this.props.paymentStatus ? _this.props.paymentStatus : '请选择',
                            style: { width: 150 },
                            value: _this.state.paymentStatus,
                            onChange: function onChange(value) {
                                return _this.handleSearchChangeCache(value, 'paymentStatus');
                            }
                        },
                        _react2.default.createElement(
                            Option,
        ...
        _this.pagination = function (current) {
            var _this$props = _this.props,
                ...
                paymentCode = _this$props.paymentCode,
                paymentName = _this$props.paymentName,
                amt = _this$props.amt,
                createTime = _this$props.createTime,
                paymentInsurerNames = _this$props.paymentInsurerNames,
                paymentStatus = _this$props.paymentStatus;
            ...
            return {
                ...
                onChange: function onChange(current) {
                    ...
                    dispatch((0, _paymentManagementListAction.paymentListRequestListData)({
                        current: current,
                        pageSize: pageSize,
                        ...
                        paymentInsurerNames: paymentInsurerNames,
        ...
        _this.handleSearchChangeCache = function (value, key) {
            if (key === 'createTime') {
                var v = value.length > 0 ? (0, _moment2.default)(value[0]._d.getTime()).format('YYYY-MM-DD') + ' 至 ' + (0, _moment2.default)(value[1]._d.getTime()).format('YYYY-MM-DD') : '';
    ...
    _createClass(PaymentManagementListApp, [{
        ...
        value: function componentWillMount() {
            var _props = this.props,
                ...
                paymentCode = _props.paymentCode,
                paymentName = _props.paymentName,
                amt = _props.amt,
                createTime = _props.createTime,
                paymentInsurerNames = _props.paymentInsurerNames,
                paymentStatus = _props.paymentStatus;
        ...
        value: function searchBtn(key) {
            ...
            if (searchParamsCashe[key]) {
                ...
                searchTitle[indexOfObject[key]] = _react2.default.createElement(_tags2.default, {
                    searchTitleText: searchTitleText[key],
                    searchText: searchText,
                    deleteSearchCashe: function deleteSearchCashe(e) {
                        return _this2.deleteSearchCashe(key);
                    }
                });
            } else {
            ...
            dispatch((0, _paymentManagementListAction.paymentListRequestListData)(_extends({
                current: current,
                pageSize: pageSize
            }, searchParamsCashe, {
                searchTitle: searchTitle
        ...
        value: function cancelButton(id) {
            ...
            dispatch((0, _paymentManagementListAction.paymentListIsVisible)({
                visible: !visible
            }));
        ...
        value: function onOk() {
            var _props5 = this.props,
                ...
                paymentCode = _props5.paymentCode,
                paymentName = _props5.paymentName,
                amt = _props5.amt,
                createTime = _props5.createTime,
                paymentInsurerNames = _props5.paymentInsurerNames,
                paymentStatus = _props5.paymentStatus;


            if (this.state.cancelReasonValue.replace(/(^\s*)|(\s*$)/g, "").length <= 0) {
                _antd.message.error('取消原因不能为空', 1);
                return false;
            } else {
                dispatch((0, _paymentManagementListAction.paymentListCancelRequest)({
        ...
        value: function render() {
            ...
            var _props7 = this.props,
                ...
                current = _props7.current,
                total = _props7.total,
                pageSize = _props7.pageSize,
                paymentCode = _props7.paymentCode,
                paymentName = _props7.paymentName,
                amt = _props7.amt,
                createTime = _props7.createTime,
                paymentInsurerNames = _props7.paymentInsurerNames,
                paymentStatus = _props7.paymentStatus,
                visible = _props7.visible,
                reload = _props7.reload,
                searchTitle = _props7.searchTitle;


            var cancelModalProps = {
                visible: visible,
                closable: true,
                title: _react2.default.createElement(
                    'span',
                    { className: _paymentManagementList2.default.cancelBtnTitle },
                    '\u53D6\u6D88\u8BF7\u6B3E\u5355'
                ),
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: _paymentManagementList2.default.paymentManagementTitle },
                        _react2.default.createElement(
                            'span',
                            null,
                            '\u8BF7\u6B3E\u7BA1\u7406'
                    ...
                    _react2.default.createElement(
                        _antd.Button,
                        { className: _paymentManagementList2.default.resetBtn, loading: isLoading, onClick: function onClick(e) {
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: _paymentManagementList2.default.cancelModal },
                        _react2.default.createElement(
                            'div',
                            { className: _paymentManagementList2.default.left },
                            '\u53D6\u6D88\u539F\u56E0\uFF1A'
                        ),
                        _react2.default.createElement(
                            'div',
                            { className: _paymentManagementList2.default.right },
                            _react2.default.createElement(
                                'div',
                                { className: _paymentManagementList2.default.cancelReason },
                                _react2.default.createElement(_antd.Input, {
                                    type: 'textarea',
                    ...
                    _react2.default.createElement(
                        'p',
                        { className: _paymentManagementList2.default.tipText },
    ...
    return PaymentManagementListApp;
}(_react.Component);

var PaymentManagementListFormApp = _antd.Form.create()(PaymentManagementListApp);

function mapStateToProps(state) {
    var data = state.getIn(['paymentManagementList']);
    return {
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(PaymentManagementListFormApp);
...
// module
exports.push([module.i, ".paymentManagementList---paymentManagementTitle---3y1XF{\r\n    border-bottom: 2px solid #22baa0;\r\n    padding-bottom: 10px;\r\n    margin-bottom: 20px;\r\n}\r\n\r\n.paymentManagementList---paymentManagementTitle---3y1XF span{\r\n    font-size: 18px;\r\n    color: #22baa0;\r\n    font-weight: bold;\r\n}\r\n\r\n\r\n.paymentManagementList---paymentInsurerNames---kGeu8{\r\n    display: inline-block;\r\n    max-width: 600px;\r\n    word-wrap: break-word;\r\n}\r\n\r\n.paymentManagementList---cancelBtn---2TOue{\r\n    cursor: pointer;\r\n    color: #108ee9;\r\n}\r\n\r\n.paymentManagementList---cancelBtnTitle---2Mq6j{\r\n    font-size: 14px;\r\n    color: rgba(0, 0, 0, 0.65);\r\n}\r\n\r\n.paymentManagementList---cancelModal---2xJG- {\r\n    overflow: hidden;\r\n}\r\n.paymentManagementList---cancelModal---2xJG- .paymentManagementList---left---2Boft{\r\n    float: left;\r\n    padding-left: 10px;\r\n}\r\n.paymentManagementList---cancelModal---2xJG- .paymentManagementList---right---3lhUb{\r\n    float: left;\r\n    width: 80%;\r\n}\r\n.paymentManagementList---tipText---2dzG0{\r\n    padding: 10px 10px 0 10px;\r\n    color: red;\r\n}\r\n.paymentManagementList---cancelReason---2ZUUf{\r\n    position: relative;\r\n}\r\n.paymentManagementList---cancelReason---2ZUUf span{\r\n    position: absolute;\r\n    bottom: 3px;\r\n    right: 10px;\r\n    color: #bbb;\r\n}\r\n\r\n.paymentManagementList---btnSearch---2l6mq {\r\n    margin-right: 10px;\r\n}\r\n\r\n.paymentManagementList---customFilterDropdown---3m8-c {\r\n    width: 100%;\r\n    padding: 8px;\r\n    border-radius: 6px;\r\n    background: #fff;\r\n    box-shadow: 0 1px 6px rgba(0, 0, 0, .2);\r\n}\r\n\r\n\r\n\r\n.paymentManagementList---resetBtn---3lAD2 {\r\n    position: absolute;\r\n    top: 0;\r\n    right: 0;\r\n}\r\n\r\n.anticon-close {\r\n    width: 32px;\r\n    line-height: 32px;\r\n    cursor: pointer;\r\n}\r\n.anticon-close:hover {\r\n    background: #00AAEF;\r\n    color: #fff;\r\n}\r\n", ""]);

// exports
exports.locals = {
	"paymentManagementTitle": "paymentManagementList---paymentManagementTitle---3y1XF",
	"paymentInsurerNames": "paymentManagementList---paymentInsurerNames---kGeu8",
	"cancelBtn": "paymentManagementList---cancelBtn---2TOue",
	"cancelBtnTitle": "paymentManagementList---cancelBtnTitle---2Mq6j",
	"cancelModal": "paymentManagementList---cancelModal---2xJG-",
	"left": "paymentManagementList---left---2Boft",
	"right": "paymentManagementList---right---3lhUb",
	"tipText": "paymentManagementList---tipText---2dzG0",
	"cancelReason": "paymentManagementList---cancelReason---2ZUUf",
	"btnSearch": "paymentManagementList---btnSearch---2l6mq",
	"customFilterDropdown": "paymentManagementList---customFilterDropdown---3m8-c",
	"resetBtn": "paymentManagementList---resetBtn---3lAD2"
};
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/.0.26.1@css-loader/index.js?modules&localIdentName=[path][name]---[local]---[hash:base64:5]!../../../node_modules/.1.2.2@postcss-loader/index.js!./paymentManagementList.css", function() {
			var newContent = require("!!../../../node_modules/.0.26.1@css-loader/index.js?modules&localIdentName=[path][name]---[local]---[hash:base64:5]!../../../node_modules/.1.2.2@postcss-loader/index.js!./paymentManagementList.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
